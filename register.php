<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $email= mysqli_real_escape_string($con, $nama);
                ...
                <div class="col-6 py-6 rounded-end" style="background-color:white">
                    <div class="container py-3 px-7">
                        ...
                        <form>
                            ...
                            <input type="text" class="form-control form-control-lg mb-3 shadow-form rounded-0" style="border-left: 6px solid #159895" id="usernameForm" placeholder="Username">
